...
@pytest.fixture
def base_data():
    # Fixed 2026-07-01: key was "likelihood" (singular); the real method
    # signature is observe_single(posterior, likelihoods, intents) --
    # plural. Narrow typo, not a design mismatch.
    return {
        "intents": ["billing", "tech", "sales"],
        "posterior": {"billing": 0.4, "tech": 0.3, "sales": 0.3},
        "likelihoods": {"billing": 0.9, "tech": 0.1, "sales": 0.5}
    }
